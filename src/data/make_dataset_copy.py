...
class GroupGenerator(object):
    ...
    def __init__(self, data_path, output_path, rating_threshold, num_groups,
        ...
        items_path = os.path.join(data_path, 'item_data.csv')
        ratings_path = os.path.join(data_path, 'market_preprocessing_20k.csv')
        ...
        items = item_df.item_id.to_list()  # self.load_items_file(items_path)

        rating_mat, timestamp_mat = self.df_to_sparse(rating_df, 'user_id', 'item_id', 'rating'), self.df_to_sparse(
            rating_df, 'user_id', 'item_id', 'timestamp')
        ...
        # shutil.copyfile(src=os.path.join(data_path, 'item_20k.csv'),
        #                 dst=os.path.join(output_path, 'item_20k.csv'))
        # shutil.copyfile(src=os.path.join(data_path, 'user_20k.csv'),
        #                 dst=os.path.join(output_path, 'user_20k.csv'))
