...
class GDataset(object):
    ...
    def __init__(self, user_path, group_path, num_negatives):
        ...
        self.user_trainMatrix = self.load_rating_file_as_matrix(user_path + "Train.dat")
        self.user_testRatings = self.load_rating_file_as_list(user_path + "Test.dat")
        self.user_testNegatives = self.load_negative_file(user_path + "TestNegative.dat")
        self.num_users, self.num_items = self.user_trainMatrix.shape
        # group data
        self.group_trainMatrix = self.load_rating_file_as_matrix(group_path + "Train.dat")
        self.group_testRatings = self.load_rating_file_as_list(group_path + "Test.dat")
        self.group_testNegatives = self.load_negative_file(group_path + "TestNegative.dat")
