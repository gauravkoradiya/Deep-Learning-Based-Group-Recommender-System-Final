...
def train(config: Config, env: Env, agent: DQNAgent, evaluator: Evaluator,
...
if __name__ == '__main__':
    ...
    agent = DQNAgent(config=config, noise=noise, group2members_dict=dataloader.group2members_dict, verbose=True)
